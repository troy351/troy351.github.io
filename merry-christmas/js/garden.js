...
Garden.options = {
    ...
    , petalStretch: {min: 0.5, max: 3}
    , growFactor: {min: 0.4, max: 1}
    , bloomRadius: {min: 10, max: 20}
    , density: 20, growSpeed: 1000 / 50
    , color: {rmin: 128, rmax: 255, gmin: 0, gmax: 128, bmin: 0, bmax: 128, opacity: 0.2}
    , tanAngle: 60
};
